# Projeto de API com conexão em banco de dados NoSql (Mongo) para realizar cadastro (Inserção, atualização, delete e recuperação) de pessoas infectadas pela COVID-19
